...
var sqlMap = {
  query: {
    // 根据管理员表登录校验
    loginInUser: `SELECT * from user where username=?`,
    // 根据客户表登录校验
    loginInCustomer: `SELECT * from customer_info where customer_id=?`,
    // 获取所有客户信息
  ...
  update: {
    ...
    updateOutRecordWithBox: `update out_record o,box b set o.status = ?,b.out_count = b.out_count - o.out_count,b.count = b.count + o.out_count where b.customer_id = o.customer_id and b.out_time = o.out_time and b.product_name = o.product_name and o.customer_id = ? and o.product_name= ? and o.out_count= ? and o.product_sku = ? and b.out_time = ? and o.record_code = ?`,
